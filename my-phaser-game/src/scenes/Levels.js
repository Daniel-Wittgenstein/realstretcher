...
const levels = [
  ...
  },  
  {
    ...
    tiles: [
      ...
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   w,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   x,   _,   ä,   _,   _,   _,   _,   w],  
      [w,   _,   b,   _,   _,   w,   w,   w,   w,   w,   w,   w,   B,   B,   B,   w,   w],  
      [w,   _,   w,   ä,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w],  
      [w,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w,   w,   w],  
      [w,   B,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   y,   Ä,   w,   w],  
