...
const levels = [
...

  {
    ...
    tiles: [
      ...
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   w,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   G,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   w,   _,   B,   _,   _,   _,   _,   _,   _,   _,   _,   B,   _,   Ü,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   B,   w],  
      [w,   _,   _,   _,   _,   _,   G,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   w,   _,   B,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   w],  
    ],
    color: "yellow",
...

  {
    ...
    tiles: [
      [w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   w,   w,   w,   w,   _,   _,   _,   _,   w],  
      [w,   _,   G,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   S,   _,   w],  
      [w,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   G,   _,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   w,   _,   w],  
      [w,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   G,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   E,   w],  
      [w,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [Ü,   _,   G,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   $,   w,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   w],  
    ],
    color: "yellow",
  },  
...

  {
    ...
    tiles: [
      ...
      [_,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _],  
      [_,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w],  
      [w,   _,   S,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w,   w],  
