...
const levels = [
...

  {
    ...
    tiles: [
      [w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   b,   _,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   B,   w,   _,   w],  
      [w,   _,   _,   _,   _,   _,   ä,   _,   ä,   _,   _,   B,   _,   _,   _,   X,   w],  
      [w,   w,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w],  
      [w,   _,   w,   _,   Ä,   _,   Ä,   _,   Ä,   _,   S,   _,   _,   _,   _,   _,   w],  
      [w,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   _,   w,   w,   w,   w,   w,   _,   _,   _,   _,   b,   _,   _,   _,   _,   w],  
      [w,   _,   y,   _,   _,   _,   _,   w,   w,   w,   w,   w,   B,   _,   _,   _,   w],  
      [w,   Ü,   x,   _,   G,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [w,   w,   w,   _,   g,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   Y,   w],  
    ]
  },  
