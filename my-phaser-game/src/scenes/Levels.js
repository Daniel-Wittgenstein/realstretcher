...
const levels = [
  ...
  
  {
    ...
    tiles: [
      ...
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   f,   b,   _,   _,   _,   _,  _,  _,  _,  _,  w],  
      [w,   ä,   ä,   _,   w,   w,   B,   w,   _,   w,   w,   w,   B,   w,   w,   w,  w,  _,  _,  _,  w],  
      [w,   _,   _,   _,   w,   _,   _,   _,   _,   _,   w,   _,   _,   _,   Ü,   _,  x,  _,  _,  _,  w],  
      [w,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w,   w,  w,  w,  w,  w,  w],  
      [w,   _,   _,   w,   _,   S,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,  _,  _,  _,  _,  w],  
      [w,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,  _,  _,  _,  _,  w],  
      [w,   w,   _,   _,   B,   w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,  _,  _,  _,  _,  w],  
      [w,   _,   Ä,   _,   _,   _,   _,   _,   _,   _,   _,   _,   X,   _,   _,   _,  _,  _,  _,  _,  w],  
      [w,   _,   Ä,   _,   _,   _,   _,   _,   w,   _,   w,   _,   w,   _,   _,   w,  w,  _,  _,  _,  w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   _,   _,  _,  _,  _,  _,  w],  
      [w,   w,   w,   w,   w,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,   $,  $,  $,  ä,  _,  w],  
    ],
  },  
