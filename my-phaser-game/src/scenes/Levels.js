...
const levels = [
...

  {
    name: "lupfer",  
    tiles: [
      [_,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w,   w],  
      [_,   _,   _,   Ä,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   ä,   ä,   w],  
      [_,   _,   _,   Ä,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   _,   _,   b,   _,   _,   _,   _,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   w,   w,   w,   w,   _,   w,   w,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [_,   _,   w,   w,   _,   _,   _,   w,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   _,   _,   Z,   b,   _,   _,   w,   w,   w,   w,   w],  
      [_,   _,   _,   _,   _,   _,   _,   _,   _,   w,   _,   _,   w,   w,   w,   _,   w],  
      [w,   w,   w,   w,   w,   _,   S,   _,   _,   _,   _,   _,   _,   y,   x,   Ü,   w],  
      [w,   w,   w,   w,   w,   _,   _,   _,   _,   _,   _,   _,   _,   w,   w,   w,   w],  
      [w,   w,   w,   w,   w,   X,   _,   _,   _,   _,   Y,   _,   _,   w,   w,   w,   w],  
    ],
    showWindow2: true,
  },  
...

  {
    name: "pancake",  
    tiles: [
      [_,   _,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w],  
      [_,   ä,   _,   _,   _,   _,   _,   _,   _,   w,   _,   _,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   Ä,   b,   _,   _,   w],  
      [_,   _,   _,   w,   _,   _,   _,   _,   w,   w,   w,   w,   w,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   _,   w,   w,   w,   w,   w,   _,   _,   _,   w],  
      [_,   _,   _,   _,   b,   _,   _,   _,   b,   _,   _,   f,   _,   _,   _,   w],  
      [S,   _,   _,   _,   w,   w,   w,   w,   w,   w,   w,   w,   _,   _,   _,   w],  
      [_,   _,   z,   _,   _,   _,   w,   w,   w,   w,   _,   w,   _,   _,   _,   w],  
      [_,   _,   _,   ä,   _,   _,   x,   c,   y,   f,   Ü,   F,   _,   _,   _,   w],  
      [_,   _,   _,   _,   _,   _,   w,   w,   w,   _,   w,   w,   _,   _,   _,   w],  
      [w,   _,   _,   C,   _,   _,   f,   F,   _,   _,   w,   w,   Y,   _,   X,   w],  
    ],  
  ...
  { //level 11
    ...
    tiles: [
      [w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w,   w],  
      [w,   _,   _,   _,  dd,  dd,   _,   _,   _,   _,   aa,  w,   _,   _,   _,   _,   w],  
      [w,   _,   S,   _,   _,   _,   _,   _,   _,   _,   aa,  w,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   aa,   w,    _,   _,   _,   _,   w],  
      [w,   w,   w,   _,   _,   _,   _,   _,   _,   _,   _,   w,   _,   _,   _,   _,   w],  
      [w,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   _,   w],  
